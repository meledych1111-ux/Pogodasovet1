...
`;
    ...
    // ✅ ФИЛЬТРУЕМ ТОЛЬКО ИГРОКОВ С 1000+ ОЧКОВ (ДОБАВЛЯЕМ ЭТОТ БЛОК!)
    ...
    console.log(`🏆 Топ игроков: ${uniquePlayers.length} игроков с 1000+ очков (убрано дублей: ${filteredRows.length - uniquePlayers.length})`);
