...
if (!BOT_TOKEN) {
    ...
    console.error('⚠️  Установите переменную окружения BOT_TOKEN в настройках Vercel');
    ...
    try {
        if (req.method === 'GET') {
            return res.status(200).json({ 
                ...
                total_phrases: dailyPhrases.length
            });
        }
...
console.log('⚡ Бот загружен и готов к работе на Vercel!');
